...
/**
 * @Description: 给图片不同位置添加多个图片水印、可设置水印图片旋转角度
 * @Author: lijinghailjh@163.com
 * @Date: 2021/9/24 16:06
 **/
public class ImageWatermark_img {
     ...
     */
    public static Boolean markImageByMoreIcon(String icon, String source, String output, String imageName, String imageType, Integer degree) {
